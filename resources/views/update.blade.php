                ...
                <form action="{{url('/home/update/' . $item->id)}}" method="post">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        <div class="form-outline flex-fill mb-0">
                            <input type="text" name="author" id="author" value="{{$item->author}}" placeholder="Author" class="form-control">
                        </div>
                    </div>

                    <div class="d-flex flex-row align-items-center mb-4">
                        <div class="form-outline flex-fill mb-0">
                            <input type="text" name="title" id="title" value="{{$item->title}}" placeholder="Book Title" class="form-control">
                        </div>
                    </div>
